...
const First = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-black font-roboto relative overflow-hidden">
      ...
      <div className="w-full h-screen max-h-screen relative z-10 p-8">
        ...
        <div className="grid grid-cols-12 grid-rows-6 gap-4 h-full">
          ...
          <div
            className={`col-span-3 row-span-6 rounded-2xl p-6 flex flex-col transition-all backdrop-blur-3xl duration-300 ${activeSection === 'status' ? 'bg-black/10' : 'bg-black/20'}`}
            style={{
