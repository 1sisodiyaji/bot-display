  ...
  return ReactDOM.createPortal(
    <AnimatePresence>
      ...
      >
        ...
        >
          <div onClick={onClose}  className="mb-2 absolute top-6 right-4  bg-red-200 inline rounded-full p-2 z-20 active:scale-85 cursor-pointer">
            <X className="animate-pulse text-red-400" />
          </div>
